                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-x-8 gap-y-4 py-10">
                    <div className="bg-white shadow-2xl relative cursor-pointer text-justify">
                        <div className="p-4">
                            ...
                            <h4 className="pt-24 text-2xl font-bold text-center">Blood Donation Campaign</h4>
                    ...
                    <div className="bg-white shadow-2xl relative cursor-pointer text-justify">
                        <div className="p-4">
                            ...
                            <h4 className="pt-24 text-2xl font-bold text-center">Health Check Facilities</h4>
                            <p className="py-6">But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give</p>
                        </div>
                    ...
                    <div className="bg-white shadow-2xl relative cursor-pointer text-justify">
                        <div className="p-4">
                            <img src={featured3} alt="" />
                            <h4 className="pt-24 text-2xl font-bold text-center">Blood Info Provide</h4>
                            <p className="py-6">But I must explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and I will give</p>
                        </div>
